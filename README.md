...
После вывода значений предлагает записать данные в файл.  
...
Написан bash-скрипт. За основу взят скрипт из [**Part 2**](#part-2-исследование-системы).  
...
Написан bash-скрипт. За основу берется скрипт из [**Part 3**](#part-3-визуальное-оформление-вывода-для-скрипта-исследования-системы). Обозначения цветов аналогичные.  
